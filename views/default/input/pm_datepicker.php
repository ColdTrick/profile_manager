...
<script type="text/javascript" src="{$url}mod/profile_manager/vendors/jquery.datepick.package-4.0.5/jquery.datepick.pack.js"></script>
<link rel="stylesheet" type="text/css" href="{$url}mod/profile_manager/vendors/jquery.datepick.package-4.0.5/redmond.datepick.css">        
END;
		if(!empty($locale_js)){
			echo "<script type='text/javascript' src='" . $url . "mod/profile_manager/vendors/jquery.datepick.package-4.0.5/" . $locale_js . "'></script>";
		}
        $datepicker = 1;
    } else {
    	$datepicker++;
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#<?php echo $internal_id;?>').datepick({
		    ...
		    showTrigger: '<img src="<?php echo $url; ?>mod/profile_manager/vendors/jquery.datepick.package-4.0.5/calendar.gif" alt="Popup" class="trigger">',
