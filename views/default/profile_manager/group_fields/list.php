...
<div class="elgg-module elgg-module-inline">
	<div class="elgg-head">
		<?php echo elgg_view("output/url", array("text" => elgg_echo("add"), "href" => "ajax/view/forms/profile_manager/group_field", "class" => "elgg-button elgg-button-action man pvn float-alt elgg-lightbox"));?>
		<h3>
