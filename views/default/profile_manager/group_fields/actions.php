...
<div class="elgg-module elgg-module-inline">
	...
	<div class="elgg-body profile-manager-actions">
		<?php
			echo elgg_view("output/confirmlink", array("text" => elgg_echo("reset"), "title" => elgg_echo("profile_manager:actions:reset:description"), "href" => "action/profile_manager/reset?type=group", "confirm" => elgg_echo("profile_manager:actions:reset:confirm"), "class" => "elgg-button elgg-button-action"));
