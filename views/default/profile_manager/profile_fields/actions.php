...
<div class="elgg-module elgg-module-inline">
	...
	<div class="elgg-body">
		<?php echo elgg_view("output/confirmlink", array("text" => elgg_echo("profile_manager:actions:reset"), "title" => elgg_echo("profile_manager:actions:reset:description"), "href" => $vars['url'] . "action/profile_manager/reset?type=profile", "confirm" => elgg_echo("profile_manager:actions:reset:confirm"), "class" => "elgg-button-action")); ?>
		...
		<?php echo elgg_view("output/url", array("title" => elgg_echo("profile_manager:actions:export:description"),"text" => elgg_echo("profile_manager:actions:export"), "href" => $vars['url'] . "admin/appearance/export_fields?fieldtype=" . CUSTOM_PROFILE_FIELDS_PROFILE_SUBTYPE, "class" => "elgg-button-action")); ?>
