...
$title .= "<a href='" . elgg_get_site_url() . "ajax/view/forms/profile_manager/group_field?guid=" . $vars['entity']->guid  . "' class='elgg-lightbox'><span class='elgg-icon elgg-icon-settings-alt' title='" . elgg_echo("edit") . "'></span></a>";
