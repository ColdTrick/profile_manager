...
$title .= "<a href='" . elgg_get_site_url() . "profile_manager/forms/profile_field/" . $vars['entity']->guid  . "' class='elgg-lightbox'><span class='elgg-icon elgg-icon-settings-alt' title='" . elgg_echo("edit") . "'></span></a>";
