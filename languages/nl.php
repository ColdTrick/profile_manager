...
$language = array (
  ...
  'profile_manager:actions:configuration:backup:description' => 'Backup de configuratie van deze velden (categorie&euml;n en types worden niet gebackupped)',
  'profile_manager:actions:configuration:restore:description' => 'Herstel een eerder gemaakte backup van de configuratie (<b>je zult wel de relatie tussen de velden en categorie&euml;n verliezen</b>)',
