...
return array (
  'profile_manager:upgrade:2026041501:title' => 'Migreer plugin switch instellingen',
  'profile_manager:upgrade:2026041501:description' => 'Plugin instellen die waren opgeslagen als yes/no worden vervangen door 1/0 voor eenvoudiger gebruik',
  ...
  'entity:delete:object:custom_profile_field_category:success' => 'De profiel categorie is verwijderd',
  'entity:delete:object:custom_profile_type:success' => 'Het profieltype is verwijderd',
  'admin:configure_utilities:group_fields' => 'Bewerk groepvelden',
  'profile_manager:admin:show_on_profile' => 'Toon op profiel',
  'profile_manager:admin:show_on_profile:description' => 'Is dit veld zichtbaar op het profiel',
  ...
  'profile_manager:settings:profile_icon_on_register' => 'Verplicht de upload van een profielfoto op het registratie formulier',
  ...
  'profile_manager:input:multi_select:empty_text' => 'Maak een keuze ...',
  ...
  'profile_manager:register:hints:email' => 'Het e-mailadres wordt gebruikt om u e-mails te sturen. Overige gebruikers kunnen dit e-mailadres niet zien.',
  ...
  'profile_manager:register_pre_check:profile_icon:error' => 'Fout bij het uploaden van de profielfoto (waarschijnlijk gerelateerd aan de grootte)',
  'profile_manager:register_pre_check:profile_icon:nosupportedimage' => 'Kan niet overweg met de profielfoto. Mogelijk is het niet van het juiste type (jpg, gif, png).',
